...
internal class CompAbilityHide : CompAbilityEffect
{
	...
	public override bool ShouldHideGizmo => hidden && !IAintBuildingThat.settings.showHiddenButtons && !(Input.GetKey(KeyCode.LeftControl) && Input.GetKey(KeyCode.LeftAlt));
